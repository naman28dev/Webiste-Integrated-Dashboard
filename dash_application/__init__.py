...
def create_dash_application(flask_app):
    ...
    html.Div(children=[
        ...
        html.Div(children=[
            html.Div(children=[
                html.Div([
                dcc.Graph(id='world_fig', figure=world_map(netflix_df))], id='World_Fig')
        ], className="col-md-6"), 
     ...
     html.Div(children=[
        html.Div(children=[
            html.Div([
                dcc.Graph(id='purst_fig', figure=fig_pie_purst(netflix_df))],
                id='PurstGraphDiv')
    ...
    def update_graph(slider_year):
        ...
        return {
            'data': [go.Scatter(
                ...
                marker=dict(size=10, symbol='circle', color='#f5f5f1',line=dict(color='blue', width=2)),
                hoverinfo='text',
                hovertext='<b>Release Year</b>: ' + filter_movie['release_year'].astype(str) + '<br>' +'<b>Type</b>: ' + filter_movie['type1'].astype(str) + '<br>' +'<b>Count</b>: ' + [f'{x:,.0f}' for x in filter_movie['type']] + '<br>'),
                ...
                go.Scatter(
                    ...
                    marker=dict(size=10, symbol='circle',color='#f5f5f1',line=dict(color='blue',width=2)),
                    hoverinfo='text',
                    hovertext='<b>Release Year</b>: ' + filter_tvshow['release_year'].astype(str) + '<br>' +'<b>Type</b>: ' + filter_tvshow['type2'].astype(str) + '<br>' +'<b>Count</b>: ' + [f'{x:,.0f}' for x in filter_tvshow['type']] + '<br>')],
            'layout': go.Layout(
                title={
